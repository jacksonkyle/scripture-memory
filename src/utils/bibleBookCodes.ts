/**
 * Maps common book names/abbreviations to the 3-letter OSIS-style codes
 * api.bible uses to identify verses (e.g. "John" -> "JHN", verse id "JHN.3.16").
 */
const BOOK_CODES: Record<string, string> = {
  ...
  "1 kings": "1KI", "1kings": "1KI", "1 kgs": "1KI", "1ki": "1KI",
  "2 kings": "2KI", "2kings": "2KI", "2 kgs": "2KI", "2ki": "2KI",
  "1 chronicles": "1CH", "1chronicles": "1CH", "1 chron": "1CH", "1chr": "1CH", "1ch": "1CH",
  "2 chronicles": "2CH", "2chronicles": "2CH", "2 chron": "2CH", "2chr": "2CH", "2ch": "2CH",
  ezra: "EZR", ezr: "EZR",
...
function normalizeBookName(book: string): string {
  return book.trim().toLowerCase().replace(/\./g, "").replace(/\s+/g, " ");
}

/** Returns the OSIS book code for a book name/abbreviation, or undefined if unrecognized. */
export function bookNameToCode(book: string): string | undefined {
  return BOOK_CODES[normalizeBookName(book)];
}
