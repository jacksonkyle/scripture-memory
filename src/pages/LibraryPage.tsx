  ...
  return (
    <div className="mx-auto max-w-2xl px-4 pb-24 pt-6 sm:pb-8">
      <div className="flex items-center justify-between gap-2">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Scripture Library</h1>
        <Link
          to="/library/new"
      ...
      {filtered.length === 0 && (
        <p className="mt-8 text-center text-slate-500 dark:text-slate-400">No Scriptures match your search.</p>
      )}
    </div>
  );
}
